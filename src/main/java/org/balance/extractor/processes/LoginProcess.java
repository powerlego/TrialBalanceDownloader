...
public class LoginProcess {
    ...
    public static void login(Driver driver, String company) {
    ...
    public static void loginGLEntry(Driver driver, String company) {
        String companyEncoded = Utils.encodeCompany(company);
        driver.get("https://nav2017-amer.navonazure.com/MTE-PRD12/WebClient/Default.aspx?company=" +
                   companyEncoded +
                   "&page=20&dc=0");
    ...
    private static void loginEntry(Driver driver) {
    ...
    private static void setValue(Driver driver, By by, String value){
